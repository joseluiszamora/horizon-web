<div class="container">
  ...
  <div id="productList" class="row">
    <div class="span12 titleTop">
      <h1 class="floatLeft">Volúmenes de la Línea</h1>
    </div>
      ...
      <div class="tabbable">
        <ul class="nav nav-tabs">
          ...
          if($this->Account_Model->get_profile() == '1')
            echo anchor('line/add_volume/'.$idLine, 'Agregar Volumen', array('class' => 'btnAdd btnTitle btn btn-primary')); 
          ?></li>
        </ul>
        <div class="tab-content">
          <div class="tab-pane active" id="tab1">
            <?php
              ...
              $this->load->view('line/line_volumes', $data);
            ?>
          </div>
