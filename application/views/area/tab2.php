      ...
      <tr>
        ...
        <td>
          ...
          <div class="btnActionsForm">
            ...
            <a href="<?php echo '#modal-'.$row->idZona ?>" role="button" class="btn btn-primary" data-toggle="modal">Activar</a>
            ...
            <div id="<?php echo 'modal-'.$row->idZona ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
              <div class="modal-header">
                ...
                <h3 id="myModalLabel">Activar Zona</h3>
              </div>
              <div class="modal-body">
                <p>Esta seguro que desea Activar esta zona ?</p>
              </div>
              <div class="modal-footer">
                <button class="btn" data-dismiss="modal" aria-hidden="true">Cancelar</button>
                <?php echo anchor('area/active/'.$row->idZona, 'Activar Zona', array('class' => 'btn btn-primary')); ?>
              </div>
            </div>
          </div>
          <?php } ?>
